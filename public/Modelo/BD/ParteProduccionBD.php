...
abstract class ParteProduccionBD extends GenericoBD
{
    ...
    public static function getParteByTarea($parteproducciontarea){
        $conexion= parent::conectar();

        $query= "SELECT * FROM partesproduccion WHERE id=(SELECT idParteProduccion FROM partesproducciontareas WHERE id=".$parteproducciontarea->getId().")";
        $rs= mysqli_query($conexion,$query) or die(mysqli_error($conexion));

        $parteproduccionT= parent::mapear($rs,"ParteProduccion");
        parent::desconectar($conexion);

        return $parteproduccionT;
